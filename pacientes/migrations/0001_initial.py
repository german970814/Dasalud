    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asistio', models.BooleanField(default=False, verbose_name='asistio con acompañante')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_pago', models.CharField(blank=True, choices=[('CO', 'Coopago'), ('CM', 'Cuota moderadora')], max_length=2, verbose_name='tipo de pago')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('NC', 'No confirmada'), ('CO', 'Confirmada'), ('CU', 'Cumplida'), ('CA', 'Cancelada'), ('EX', 'Excusada'), ('NA', 'No asistio')], default='NC', max_length=2, verbose_name='estado')),
